...
df_final['pos x'] = df_final['pos x'].str.replace('.',',').astype(float) # Transformo los datos para la columna X
df_final['pos y'] = df_final['pos y'].str.replace('.',',').astype(float) # Transformo los datos para la columna Y
